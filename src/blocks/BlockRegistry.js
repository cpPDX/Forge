...
const DEFS = {
  ...
  [B.GLASS]:         { name:'Glass',          faces: all(T.GLASS),                             solid:true,  hard:0.3,  tool:null,     drops:null, transparent:true  },
  [B.COAL_ORE]:      { name:'Coal Ore',       faces: all(T.COAL_ORE),                          solid:true,  hard:3.0,  tool:'pickaxe',drops:null       },
  [B.IRON_ORE]:      { name:'Iron Ore',       faces: all(T.IRON_ORE),                          solid:true,  hard:3.0,  tool:'pickaxe',drops:null       },
  [B.GOLD_ORE]:      { name:'Gold Ore',       faces: all(T.GOLD_ORE),                          solid:true,  hard:3.0,  tool:'pickaxe',drops:null       },
  [B.DIAMOND_ORE]:   { name:'Diamond Ore',    faces: all(T.DIAMOND_ORE),                       solid:true,  hard:3.0,  tool:'pickaxe',drops:null       },
  ...
  [B.GLOWSTONE]:     { name:'Glowstone',      faces: all(T.GLOWSTONE),                         solid:true,  hard:0.3,  tool:'pickaxe',drops:null, lightEmit:15                    },
